...
const Home = () => {
  ...
  return (
    <main className=" mt-[80px] lg:mt-[110px] px-6 py-8">
      <form onSubmit={handleSubmit}>
        <div className="flex items-center justify-center mx-auto md:ml-[200px]">
          <input
            ...
            type="text"
            className="border border-gray-300 py-3 px-6 text-sm  md:px-[200px] lg:px-[250px]"
          />
          <button className="bg-violet-600 text-white px-4 py-3 transition duration-300 transform hover:scale-110 focus:scale-110 rounded-sm lg:px-10 md:px-10">
            <i className="bx bx-search bx-flashing"></i>
          </button>
        </div>

        <div className="flex justify-end mx-0 my-0 mr-auto mb-auto ml-10 mt-2 md:[200px] lg:mr-[270px]">
          <button
            className="text-lg text-gray-400 transition duration-300 transform hover:scale-110 focus:scale-110 mt-3"
        ...
        >
          ...
          <li
            ...
            data-category={0}
            className=" text-center  mt-2 font-semibold transition duration-300 transform hover:scale-110 focus:scale-110 cursor-pointer"
          >
            All
          </li>
      ...
      <section className="px-2 grid gap-5 auto-rows-auto grid-cols-[repeat(auto-fill,_250px)]  justify-center">
