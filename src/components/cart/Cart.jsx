...
const Cart = () => {
  ...
  return (
    <section className={` fixed top-0 bg-white h-screen w-[300px] shadow-xl ${isShowCart && token ? "right-0" : "-right-full"} duration-500 p-3 grid grid-rows-[auto_1fr_auto]`}>
        ...
        <h2 className='text-xl font-bold text-violet-500 mt-[50px] lg:mt-[90px] mr-[130px]'>Shopping cart</h2>
        <i onClick={handleClickChangeShowCart} className="bx bx-x text-gray-500 hover:text-violet-600 focus:outline-none text-xl absolute top-16 lg:top-[100px] right-3"></i>
          ...
          <section className='grid grid-cols-2 py-6 border-t-[1px] border-gray-400'>
            ...
            <button onClick={handleClickCheckout} className='col-span-2 ml-4 rounded-md w-[250px] bg-violet-600 py-2 text-white hover:bg-violet-400 transition duration-300 transform hover:scale-90 rouded-sm '>
            Checkout
            </button>
          </section>
    </section>
