  ...
  return (
    <article className='mt-4'>
        <section className='grid grid-cols-[auto_1fr_auto] gap-2'>
            ...
            <i onClick={handleClickDelete} className='bx bx-trash text-violet-500 hover:text-violet-700 transition duration-300 transform hover:scale-110 cursor-pointer'></i>

            <div className=' flex items-center'>
            <button className='border-[1px] p-2 px-4 transition duration-300 transform hover:scale-110 focus:scale-110 hover:bg-violet-600 hover:text-white'>-</button>
