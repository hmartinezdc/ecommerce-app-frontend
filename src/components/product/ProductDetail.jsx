      ...
      <section className='grid grid-cols-2 mt-6'>
        ...
        <article>
          ...
          <div className=' flex items-center'>
            <button onClick={handleClickLess} className='border-[1px] p-2 px-4 transition duration-300 transform hover:scale-110 focus:scale-110 hover:bg-violet-600 hover:text-white'>-</button>
            <span className='border-[1px] p-2 px-4 border-x-0'>{couter}</span>
            <button onClick={handleClickPlus} className='border-[1px] p-2 px-4 transition duration-300 transform hover:scale-110 focus:scale-110 hover:bg-violet-600 hover:text-white'>+</button>
          </div>

        </article>
      </section>

      <button onClick={handleClickAddToCart} className='w-full bg-violet-600 py-2  text-white hover:bg-violet-400 transition duration-300 transform hover:scale-90 rouded-sm mt-6'>
